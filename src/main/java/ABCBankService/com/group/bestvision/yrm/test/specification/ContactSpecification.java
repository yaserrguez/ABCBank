...
package ABCBankService.com.group.bestvision.yrm.test.specification;

import ABCBankService.com.group.bestvision.yrm.test.dto.ContactSearchFilterDto;
    ...
    public static Specification<ContactEntity> searchFilterSpecification(ContactSearchFilterDto filter)
    {
        ...
        return (Specification<ContactEntity>) (root, criteriaQuery, criteriaBuilder) -> {
            ...
            if (filter.getAddress() != null && !filter.getAddress().isEmpty())
            {
                ...
                Join<AddressEntity, ContactEntity> type = root.join("address");
